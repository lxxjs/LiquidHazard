...
namespace TestMain
{
	...
	static void SimulationLoop()
	{
		...
		if (testSelection != testIndex || restartTest)
		{
			...
			settings.viewCenter.Set(0.0f, 20.0f * viewZoom - 9.0f);
			Resize(width, height);
		}
...
int main(int argc, char** argv)
{
	...
	sprintf(title, "OOP Final Project Version 1.0.0");
	...
	glui->add_statictext("Liquid Hazard");

	glui->add_button("Pause / Resume", 0, Pause);
